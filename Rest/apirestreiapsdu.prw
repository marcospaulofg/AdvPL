...
//+------------------------------------------------------------------------------------------------------------------+
//| Programa | MT4REIDOAPSDU10ALT | Autor | JSangelles Moraes | Data | 18.12.2022 | 
//+------------------------------------------------------------------------------------------------------------------+
...
WSRESTFUL REIDOAPSDU DESCRIPTION "API REST Protheus Rei do Apsdu" FORMAT APPLICATION_JSON
...
WSMETHOD GET ConsultaFornecedor HEADERPARAM cpfCnpjForn, codigoLojaForn, nomeForn  WSSERVICE REIDOAPSDU

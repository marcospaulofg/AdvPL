...
Static Function fGeraExcel()
    ...
    cQuery += "LEFT JOIN "+RetSQLName("SD1010")+" ON (E5_FILIAL = D1_FILIAL AND E5_PREFIXO = D1_SERIE AND E5_NUMERO = D1_DOC AND E5_CLIFOR = D1_FORNECE AND D1_ITEM = '0001' AND SD1010.D_E_L_E_T_ = ' ') " + CRLF
    cQuery += "LEFT JOIN "+RetSQLName("SD2010")+" ON (E5_FILIAL = D2_FILIAL AND E5_PREFIXO = D2_SERIE AND E5_NUMERO = D2_DOC AND E5_CLIFOR = D2_CLIENTE AND D2_ITEM = '01' AND SD2010.D_E_L_E_T_ = ' ') " + CRLF
